...
public class ImageStorageServiceImpl implements ImageStorageService {
    ...
    @Override
    public String saveProvinceImage(MultipartFile file, String fileName) {
        try {
            r = this.cloudinary().uploader().upload(file.getBytes(), ObjectUtils.asMap("resource_type","auto","upload_preset","bang","public_id","province_image/"+fileName));
        } catch (IOException e) {
            throw new RuntimeException("Upload fail");
        }
        return (String) r.get("secure_url");
    ...
    @Override
    public String saveUserImage(MultipartFile file, String fileName) {
        try {
            r = this.cloudinary().uploader().upload(file.getBytes(), ObjectUtils.asMap("resource_type","auto","upload_preset","bang","public_id","user_image/"+fileName));
        } catch (IOException e) {
            throw new RuntimeException("Upload fail");
        }
        return (String) r.get("secure_url");
    ...
    @Override
    public String savePlaceImage(MultipartFile file, String fileName) {
        try {
            r = this.cloudinary().uploader().upload(file.getBytes(), ObjectUtils.asMap("resource_type","auto","upload_preset","bang","public_id","place_images/"+fileName));
        } catch (IOException e) {
            throw new RuntimeException("Upload fail");
        }
        return (String) r.get("secure_url");
