...
public interface BookingRepository extends JpaRepository<BookingEntity,String> {
    ...
    @Query(value = "select * from bookings where stay_id=?1 and (checkin_date between ?2 and ?3) and status=1",nativeQuery = true)
    ...
    List<BookingEntity> getAllByStay_Host(UserEntity user);
